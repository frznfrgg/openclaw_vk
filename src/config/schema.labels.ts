...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.vk.communityId": "VK Community ID",
  "channels.vk.communityAccessToken": "VK Community Access Token",
  "channels.vk.tokenFile": "VK Community Access Token File",
  "channels.vk.defaultTo": "VK Default Target",
  "channels.vk.allowFrom": "VK DM Allowlist",
  "channels.vk.groupAllowFrom": "VK Group Sender Allowlist",
  "channels.vk.dmPolicy": "VK DM Policy",
  "channels.vk.groupPolicy": "VK Group Policy",
  "channels.vk.groups": "VK Group Admission Map",
  "channels.vk.healthMonitor": "VK Health Monitor",
  "agents.list[].skills": "Agent Skill Filter",
